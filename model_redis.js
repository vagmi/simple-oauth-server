...
var oauthAccessTokens = [],
    ...
    oauthClients = [{
        ...
        redirectUri: 'http://oauthclient:4000/'
    }],
    authorizedClientIds = {
        password: ['thom'],
        token: ['thom'],
...
model.getAccessToken = function(bearerToken, callback) {
  // TODO: Get access token by token returning client_id, user_id, expires
...
model.getRefreshToken = function(bearerToken, callback) {
  // TODO: Get refresh token by token returning client_id, user_id, expires
...
model.getClient = function(clientId, clientSecret, callback) {
  // TODO: Get client_id, client_secret and redirect_uri if given only client_id
  // TODO: Validate if client_id and client_secret match and then return client_id, client_secret and redirect_uri else call back with error
...
model.grantTypeAllowed = function(clientId, grantType, callback) {
  // TODO: get grant types for client and check if the grant type exists for clientId
    callback(false, authorizedClientIds[grantType] && authorizedClientIds[grantType].indexOf(clientId.toLowerCase()) >= 0);
};

model.saveAccessToken = function(accessToken, clientId, expires, userId, callback) {
  // TODO: set accessToken's hash to client_id, expires and user_id
...
model.saveRefreshToken = function(refreshToken, clientId, expires, userId, callback) {
  // TODO: set refreshToken's hash to client_id, expires and user_id
...
model.getUser = function(username, password, callback) {
  // TODO: Validate username, password and return the user object
